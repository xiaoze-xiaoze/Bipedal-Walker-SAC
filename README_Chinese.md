# BipedalWalker的Soft Actor-Critic实现

使用PyTorch实现的Soft Actor-Critic (SAC)算法，用于训练BipedalWalker-v3环境中的行走任务。

## 项目介绍

这个项目使用SAC算法训练AI智能体学会行走。SAC结合了策略梯度和Q学习的优势，并且具有自动熵调节功能，能够更好地平衡探索和利用。
